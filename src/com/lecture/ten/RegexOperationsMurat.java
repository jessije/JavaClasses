...
public class RegexOperationsMurat {
    public static void main(String[] args) {
        ...
        String someDummyString = "..x";
        Matcher matcher = pattern.matcher(someDummyString);
        System.out.println("1. Input String matches the regex - " + matcher.matches());
        /**
         *  . Matches any single character
         */
        Pattern pattern1 = Pattern.compile("(?i)..xx.");
        Matcher matcher1 = pattern1.matcher(someDummyString);
        System.out.println("2.Input String matches - " + matcher1.matches());
        /**
         * ^xxx   Matches xxx regex at the beginning of the line
         * (“^a.c.”, “abcd”) – true
         */
        System.out.println("3 Using the String matches - " +
